...
SCRIPT_VERSION = '1.0'
SCRIPT_LICENSE = 'GPL3'
SCRIPT_DESC = 'Replace words with emoji'
SCRIPT_COMMAND = ''
...
# Grabbed from https://github.com/carpedm20/emoji
EMOJI_UNICODE = {
...
def convert_text_emoji_cb(data, modifier, modifier_data, message):
    _, _, tags = modifier_data.split(';')
    tags = tags.split(',')
    ...
    if 'irc_privmsg' in tags:
        ...
        for word in text.split(' '):
            if word in EMOJI_UNICODE:
                message += EMOJI_UNICODE[word] + ' '
            else:
                message += word + ' '
...
if __name__ == '__main__':
    if weechat.register(SCRIPT_NAME, SCRIPT_AUTHOR, SCRIPT_VERSION, SCRIPT_LICENSE, SCRIPT_DESC,'', ''):
        weechat.hook_modifier('weechat_print', 'convert_text_emoji_cb', '')
